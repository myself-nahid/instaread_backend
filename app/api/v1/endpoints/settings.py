...
async def get_legal_documents():
    ...
    data = {
        "privacy_policy":[
            {"title": "1. Information We Collect", "body": "Our app requires access to your device's camera to scan book covers or barcodes..."},
            {"title": "1.2 Uploaded Book Data", "body": "When you scan or upload a book, the app may process: Book cover images, ISBN or barcode information, Text extracted from the book..."},
            {"title": "1.3 Usage Information", "body": "We may collect limited information about how you use the app, such as: Features used, Scan activity, Device type..."}
        ],
        "terms_and_agreement": {
